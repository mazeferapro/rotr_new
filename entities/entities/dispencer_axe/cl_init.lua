...
function ENT:Draw()
	...
	if alpha > 0 then
		...
		local dX,dY = surface.GetTextSize("Аренда топора")

		surface.SetDrawColor(32,32,32,125)

			draw.SimpleTextOutlined("Аренда топора","Trebuchet24",50,-150,Color(235,235,235),TEXT_ALIGN_CENTER,TEXT_ALIGN_TOP,0,Color(25,25,25))
