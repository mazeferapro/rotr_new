function NextRP.Friends:MainFrame()
    ...
    MainFrame:TDLib():On('Paint', function(s, w, h)
        ...
        draw.SimpleText('Введёный код даёт вам и', 'font_sans_21', w * .5, 180, nil, TEXT_ALIGN_CENTER)
        draw.SimpleText('вашему другу по 100 рублей.', 'font_sans_21', w * .5, 200, nil, TEXT_ALIGN_CENTER)
    end)
    ...
    enterCode:TDLib() 
        ...
        :On('DoClick', function()
            NextRP:QuerryText(QUERY_MAT_QUESTION, NextRP.Style.Theme.Accent, 'Введи код друга.\nПосле того как код будет применён вы получите 100 рублей на донат счёт.\n\nКод можно ввести только один раз!', '', 'Подтвердить!', function(sValue)
