...
NextRP.Style.Theme = {
    ...
    Accent = Color(205, 0, 0),          -- Цвет для элементов декора. (полосы, разделители и т.д.)
...
NextRP.Style.Materials = {
    ...
    LogoWatermark = 'https://i.imgur.com/94Fgu2c.png',              -- Лого "Ватермарка", без лишних элементов
    LogoNormal = 'https://i.imgur.com/94Fgu2c.png',                 -- Нормальное лого
