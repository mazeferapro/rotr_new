NextRP.Config.Title = 'Resurgence Of The Republic'
NextRP.Config.FancyTitle = 'ROTR'
NextRP.Config.ShortCode = 'ROTR'
...
NextRP.Config.AutoChatMessages = {
    ...
    -- {text, 'За новостями сообщества вы можете следить в ', yellow, 'группе ВК ', accent, NextRP.Config.Link.VK, text, ' или на ', yellow, 'сервере Discord ', accent, NextRP.Config.Link.Discord},
